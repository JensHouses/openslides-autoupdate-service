...
var relationFields = map[string]string{
	...
	"projector/used_as_default_$":                                       "meeting/default_projector_$_ids",
...
var genericRelationFields = map[string]map[string]string{
	...
	"option/content_object_id":           {"motion": "option_ids", "poll_candidate_list": "option_id", "user": "option_$_ids"},
...
var restrictionModes = map[string]string{
	...
	"meeting/default_projector_$_ids":                            "B",
...
var collectionFields = map[string][]string{
	...
	"projector":                    {"aspect_ratio_denominator", "aspect_ratio_numerator", "background_color", "chyron_background_color", "chyron_font_color", "color", "current_projection_ids", "header_background_color", "header_font_color", "header_h1_color", "history_projection_ids", "id", "meeting_id", "name", "preview_projection_ids", "scale", "scroll", "sequential_number", "show_clock", "show_header_footer", "show_logo", "show_title", "used_as_default_$", "used_as_default_$_in_meeting_id", "used_as_reference_projector_meeting_id", "width"},

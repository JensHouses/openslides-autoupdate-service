...
var collectionFields = map[string][]string{
	...
	"committee":                    {"default_meeting_id", "description", "external_id", "id", "meeting_ids", "name", "organization_id", "organization_tag_ids", "user_ids", "forward_to_committee_ids", "forwarding_user_id", "receive_forwardings_from_committee_ids", "user_$", "user_$_management_level"},
	"group":                        {"admin_group_for_meeting_id", "default_group_for_meeting_id", "external_id", "id", "mediafile_access_group_ids", "mediafile_inherited_access_group_ids", "meeting_id", "name", "permissions", "poll_ids", "read_chat_group_ids", "read_comment_section_ids", "used_as_assignment_poll_default_id", "used_as_motion_poll_default_id", "used_as_poll_default_id", "used_as_topic_poll_default_id", "user_ids", "weight", "write_chat_group_ids", "write_comment_section_ids"},
	...
	"projector":                    {"aspect_ratio_denominator", "aspect_ratio_numerator", "background_color", "chyron_background_color", "chyron_font_color", "color", "current_projection_ids", "header_background_color", "header_font_color", "header_h1_color", "history_projection_ids", "id", "is_internal", "meeting_id", "name", "preview_projection_ids", "scale", "scroll", "sequential_number", "show_clock", "show_header_footer", "show_logo", "show_title", "used_as_default_$", "used_as_default_$_in_meeting_id", "used_as_reference_projector_meeting_id", "width"},
